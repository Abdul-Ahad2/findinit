      ...
      <div className="relative pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 h-[27vh] gap-2 mb-20 px-32">
            <div className="border-5 flex items-center justify-center border-blue-600 p-8 bg-black/50">
              <div className="text-center">
                <div className="text-5xl font-extrabold text-blue-500 mb-2">
                  4
                </div>
                <div className="text-lg text-gray-200">DOCUMENTS</div>
              </div>
            </div>
            <div className="border-5 border-blue-600 p-8 flex items-center justify-center bg-black/50">
              <div className="text-center">
                <div className="text-5xl font-extrabold text-blue-500 mb-2">
                  869
                </div>
                <div className="text-lg text-gray-200">CHUNKS</div>
              </div>
            </div>
            <div className="border-5 flex items-center justify-center border-blue-600 p-8 bg-black/50">
              <div className="text-center">
                ...
                <div className="text-lg text-gray-200">STORAGE USED</div>
              </div>
            </div>
            <div className="border-5 border-blue-600 p-8 flex items-center justify-center bg-black/50">
              <div className="text-center">
                ...
                <div className="text-lg text-gray-200">QUERIES</div>
              </div>
            </div>
          </div>
          ...
          {/* Recent Documents */}
          <div>
            <h2 className="text-6xl px-32 tracking-tighter font-extrabold text-white mb-8">
              RECENT &nbsp; DOCUMENTS
            </h2>
            <div className="space-y-2 px-32">
              {mockDocuments.map((doc) => (
                <div
                  key={doc.id}
                  className="border-5 border-blue-600 p-6 bg-black/50 hover:bg-black/70 transition flex items-center justify-between"
                >
                  ...
                  <button className="px-6 py-2 border-5 border-gray-500 hover:bg-blue-500/20 transition text-gray-400">
                    SEARCH
                  </button>
                </div>
              ))}
